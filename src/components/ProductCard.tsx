...
export default function ProductCard({ product }: ProductCardProps) {
  const handleBuy = () => {
    ...
    const defaultMessage = `Hola, me interesa comprar el producto: *${product.name}* por Bs. ${formattedPrice}.`;
    const whatsappUrl = `https://wa.me/5211234567890?text=${encodeURIComponent(defaultMessage)}`;
